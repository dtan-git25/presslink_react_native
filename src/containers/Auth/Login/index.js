...
import {AppButton, Form, MaterialTextField} from '@reuseableComponents';
  ...
  return (
    <Page bounces={false}>
      ...
      <View style={styles.forgotPassCont}>
        <TouchableOpacity onPress={pushTo('ForgotPassword')}>
      ...
      <View style={styles.btmCont}>
        ...
        />
        <Text style={styles.medTxt}>or you can also :</Text>
        <AppButton
      ...
      <View style={styles.signUpView}>
        <TouchableOpacity onPress={pushTo('SignUp')}>
