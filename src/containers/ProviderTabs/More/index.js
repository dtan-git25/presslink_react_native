    ...
    <View style={styles.container}>
      ...
      <View style={styles.containerWhite}>
        <Row
          ...
          img={Images.icLock}
          onPress={pushTo('ProviderChangePassword')}
        />
        <Row
          title="My Earnings"
          img={Images.icPayment}
          onPress={pushTo('ProviderMyEarnings')}
        />
        <Row
          title="Bank Account Details"
          img={Images.icbankAccount}
          onPress={pushTo('ProviderBankDetails')}
        />
        <Row
          title="FAQs"
          img={Images.icFaqs}
        ...
        <Row
          ...
          onPress={() => {
            navigate('ContentPage', {
              link: 'https://fostering-in-unity.dev.retrocubedev.com/privacy-policy',
              title: 'Privacy Policy',
            });
          }}
        />
...
const styles = StyleSheet.create({
  ...
  txtRowTitle: {
    ...
    flex: 1, paddingHorizontal: Metrics.baseMargin,
  },
  containerWhite: {
